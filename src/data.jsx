...
export default [
  {
    ...
    title: "Life Lessons with Katie Zaferes hello world",
    description:
      'I will share with you what I hello world call "Positively Impactful Moments of Disappointment." Throughout my career, many of my highest moments only came after setbacks and losses. But learning from those difficult moments is what gave me the ability to rise above them and reach my goals.',
    price: 140,
    stats: {
      rating: 5.0,
      reviewCount: 6,
